        ...
        <div class="row">
            ...
            <div class="col-lg-4 box">
                <img class="h-[60px] w-auto" src="{{ asset('Frontend/icons/text_icon/genuine.png') }}" alt="">
                    <h4 class="title">
                        <a href="" style="color: var(--brand-green) !important;">Genuine PVA Accounts</a>
                    </h4>
                <p class="description">
            ...
            <div class="col-lg-4 box border-l border-[#f1f1f13b] border-r shadow">
                <img class="h-[60px] w-auto" src="{{ asset('Frontend/icons/text_icon/gift-box.png') }}" alt="">
                    <h4 class="title">
                        <a href="" style="color: var(--brand-green) !important;">Multiple Packages</a>
                    </h4>
                <p class="description">
            ...
            <div class="col-lg-4 box">
                ...
                <h4 class="title">
                    <a href="" style="color: var(--brand-green) !important;">Fast & Secure Delivery</a>
                </h4>
                <p class="description">
