                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" type="text" class="form-control" value="{{ $user->name }}">
                            </div>
                            @error('name')
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" type="text" class="form-control" value="{{ $user->email }}">
                            </div>
                            @error('email')
                              <div id="emailHelp" class="form-text">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="number" name="phone" type="text" class="form-control" value="{{ $user->phone }}">
                            </div>
                            @error('phone')
                              <div id="emailHelp" class="form-text">{{ $message }}</div>
                            @enderror
