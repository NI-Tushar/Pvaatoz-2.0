    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="fw-bolder">Update Slider</h5>
                <a href="{{ route('admin.slider.index') }}" class="btn btn-md btn-outline-primary"><i class="fa-solid fa-reply"></i></a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.slider.update', $slider->slug) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                <div class="row">
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="sub_title" type="text" class="form-control char-count" data-limit="30" value="{{ old('sub_title', $slider->sub_title) }}">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" type="text" class="form-control char-count" data-limit="80" value="{{ old('title', $slider->title) }}">
                                        <div class="d-flex align-items-center" style="gap: 1em">
                        ...
                        <div class="m-2 mt-4 card">
                            ...
                            <div class="card-body">
                                <div style="position: relative; border: 1px solid #ddd; padding: 5px; width: 150px; height: 150px; margin-top: 10px;">
                                    <img id="ImagePreview" style="width: 100%; height: 100%; object-fit: cover;" src="{{ asset($slider->image ? $slider->image : 'img-preview.png') }}" alt="">
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control char-count" rows="17" data-limit="500">{{ $slider->description }}</textarea>
                                        <div class="d-flex align-items-center" style="gap: 1em">
