...
@section('master-content')
    <div class="card">
        ...
        <div class="card-body">
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" id="myForm">
                @csrf
                @method('POST')
                <div class="row">
                            ...
                            <div class="card-body">
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" type="text" class="form-control char-count" data-limit="30">
                        ...
                        <div class="m-2 mt-4 card">
                            ...
                            <div class="card-body">
                                <div style="position: relative; border: 1px solid #ddd; padding: 5px; width: 150px; height: 150px; margin-top: 10px;">
                                    <img id="iconImagePreview" style="width: 100%; height: 100%; object-fit: cover;" src="{{ asset('img-preview.png') }}" alt="">
