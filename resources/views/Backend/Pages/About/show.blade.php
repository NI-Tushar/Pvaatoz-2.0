...
<div class="card">
    <div class="card-header">
        <div class="d-flex justify-content-between align-items-center">
            <h5 class="fw-bolder">View About Information</h5>
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="title" type="text" class="form-control char-count" value="{{ $about->title }}" disabled>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-6 com-sm-12">
                <div class="m-2 card">
                    ...
                    <div class="card-body">
                        <div class="mb-3">
                            <div class="form-group">
                                <textarea name="description" class="form-control char-count" rows="14" disabled>{{ strip_tags($about->description) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
