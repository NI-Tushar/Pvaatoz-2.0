                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="title" type="text" class="form-control char-count" data-limit="255">
                        ...
                        <div class="col-md-6 com-sm-12">
                            <div class="m-2 card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <textarea name="description" class="form-control char-count" rows="10" data-limit="1000"></textarea>
                                            <div class="d-flex align-items-center" style="gap: 1em">
