    ...
    <div class="card">
        <div class="card-header">
            <div class="d-flex justify-content-between align-items-center">
                <h5 class="fw-bolder">Update this Package</h5>
                <a href="{{ route('admin.proUser.packages') }}" class="btn btn-md btn-outline-primary"><i class="fa-solid fa-reply"></i></a>
            </div>
        </div>
        <div class="card-body">
            <form action="{{ route('admin.userPackages.storeUpdate') }}" method="POST" enctype="multipart/form-data" id="myForm">
                @csrf
                @method('POST')
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="name" type="text" value="{{$update_data->name}}" placeholder="Basic, Standard, Premium etc" class="form-control char-count" data-limit="30">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="level" value="{{$update_data->level}}" placeholder="Starter, Populer, Best Value etc" type="text" class="form-control char-count" data-limit="30">
                                        <div class="d-flex align-items-center" style="gap: 1em">
                                          <small style="font-size: 16px" class="form-text text-muted counter">0/30</small>
                                          <small style="font-size: 16px" class="form-text text-danger error d-none">Character limit exceeded!</small>
                                        </div>
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="duration" type="number" value="{{$update_data->duration}}" placeholder="Duration in month" class="form-control char-count" data-limit="30">
                                        <div class="d-flex align-items-center" style="gap: 1em">
                                          <small style="font-size: 16px" class="form-text text-muted counter">0/30</small>
                                          <small style="font-size: 16px" class="form-text text-danger error d-none">Character limit exceeded!</small>
                                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" class="form-control char-count" rows="3" data-limit="50">{{$update_data->description}}</textarea>
                                        <div class="d-flex align-items-center" style="gap: 1em">
                                ...
                                <div>
                                    <div class="form-group">
                                        ...
                                        <input name="price" type="number" value="{{$update_data->price}}" placeholder="Package Price" class="form-control char-count" data-limit="30">
                                        <div class="d-flex align-items-center" style="gap: 1em">
                                          <small style="font-size: 16px" class="form-text text-muted counter">0/30</small>
                                          <small style="font-size: 16px" class="form-text text-danger error d-none">Character limit exceeded!</small>
                                        </div>
                               ...
                               @if($update_data->features != '')
                                    <div class="form-group">
                                        ...
                                        @php
                                            $update_data['features'] = json_decode($update_data['features'], true);
                                        @endphp

                                        <div id="features-container">
                                            @foreach ($update_data['features'] as $feature)
