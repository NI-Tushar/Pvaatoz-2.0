                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="name" type="text" class="form-control char-count" data-limit="255" value="{{ $testimonial->name }}">
                                    ...
                                    <div class="mb-3">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="designation" type="text" class="form-control char-count" data-limit="255" value="{{ $testimonial->designation }}">
                                            <div class="d-flex align-items-center" style="gap: 1em">
                                              <small style="font-size: 16px" class="form-text text-muted counter">0/255</small>
                                              <small style="font-size: 16px" class="form-text text-danger error d-none">Character limit exceeded!</small>
                                            </div>
                        ...
                        <div class="col-md-6 com-sm-12">
                            <div class="m-2 card">
                                ...
                                <div class="card-body">
                                    <div class="mb-3">
                                        <div class="form-group">
                                            <textarea name="description" class="form-control char-count" rows="19" data-limit="1000">{!! $testimonial->description !!}</textarea>
                                            <div class="d-flex align-items-center" style="gap: 1em">
