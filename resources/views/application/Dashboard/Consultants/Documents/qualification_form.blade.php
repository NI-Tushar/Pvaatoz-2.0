...
<div class="row">
    <div class="col-md-6 com-sm-12">
        <form method="POST" action="{{ route('consultant.qualification.add') }}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="m-2 card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="label_of_edu" type="text" class="form-control" placeholder="Exam/Degree/Title" required>
                        </div>
                        @error('name')
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="title" placeholder="Degree Name" required>
                        </div>
                        @error('email')
                        <div id="emailHelp" class="form-text">{{ $error_error_message }}</div>
                        @enderror
        ...
        <div class="m-2 mt-4 card">
            ...
            <div class="card-body">
                ...
                @error('image')
                <div id="emailHelp" class="form-text">{{ $error_message }}</div>
                @enderror
            </div>
        </div>
    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="institution" class="form-control" placeholder="Name of your institution" required>
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $error_message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="passing_year" class="form-control" placeholder="Your Passing Year" required>
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $error_message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="cgpa" class="form-control" placeholder="Your GPA/CGPA">
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $error_message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="duration" class="form-control" placeholder="Duration of your Degree" required>
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $error_message }}</div>
                        @enderror
