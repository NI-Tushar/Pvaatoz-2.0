...
<div class="row">
    <div class="col-md-6 com-sm-12">
        <form method="POST" action="{{ route('consultant.service.add') }}" method="POST" enctype="multipart/form-data">
        @csrf
            <div class="m-2 card">
                <div class="card-header">
                    <h4>Add Your Consultancy Services:</h4>
                </div>
                <div class="card-body">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="email" class="text-gray" class="form-label">Add Country:</label>
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            <label for="email" class="text-gray" class="form-label">Add Subject:</label>
