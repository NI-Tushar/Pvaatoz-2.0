                ...
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body position-relative">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small">Earnings</h6>
                                <h3 class="mb-2">
                                ...
                                <p class="mb-0 text-success small">
                                    ...
                                    <span>+{{ number_format(auth()->user()->balance, 2) }}</span> Last 10 Days
                                </p>
                            </div>
                            <div
                                class="bg-primary bg-opacity-10 rounded-circle p-3 d-flex align-items-center justify-content-center">
                    ...
                    <div class="card-body position-relative">
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <p class="mb-0 text-success small">
                                    <i class="bi bi-arrow-up"></i>
                                    <span>+{{ number_format($balance, 2) }}</span> Last 10 Days
                                </p>
                            </div>
                            <div
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card h-100 border-0 shadow-sm">
                    <div class="card-body position-relative">
                        <div class="d-flex justify-content-between">
                            <div>
                                <h6 class="text-muted mb-1 text-uppercase small">Total Review</h6>
                                <h3 class="mb-2">{{ $total_review }}</h3>
                                <p class="mb-0 text-success small">
                                    <i class="bi bi-arrow-up"></i>
                                    <span>+{{ number_format($balance, 2) }}</span> Last 10 Days
                                </p>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <h5 class="card-title fw-bold mb-3 d-flex align-items-center">
                            <i class="bi bi-bell text-primary me-2"></i>New Requests
                        </h5>
                                ...
                                <div class="list-group-item border-0 p-0 mb-3">
                                    <div class="d-flex">
                                        <div class="flex-shrink-0">
                                            <img src="{{ $request->student->image ?? 'https://t4.ftcdn.net/jpg/03/64/21/11/360_F_364211147_1qgLVxv1Tcq0Ohz3FawUfrtONzz8nq3e.jpg' }}"
                                                class="rounded-circle" width="50" height="50" alt="Student">
                                        </div>
                                        <div class="flex-grow-1 ms-3">
                                            <div class="d-flex justify-content-between align-items-start">
                                                <h6 class="mb-1">{{ $request->student->name }} <span
                                                        class="badge bg-primary ms-2">New</span></h6>
                                                <span class="badge bg-light text-dark">{{ $request->service_name }}</span>
                                            </div>
                                            <p class="text-muted small mb-2">
                                                {{ Str::limit($request->assessment_description, 50) }}</p>
                                            <a href="{{ route('consultant.assessment.details', $request->id) }}"
                        ...
                        @empty
                            <div class="list-group-item border-0 p-0 mb-3">
                                <p class="text-muted">No new requests available.</p>
                            </div>
                        @endforelse

                        <!-- Last Completed Section -->
                        <h5 class="card-title fw-bold mb-3 d-flex align-items-center">
                            <i class="bi bi-check-circle text-success me-2"></i>Accepted Requests
                        </h5>
                        ...
                        @empty
                            <div class="list-group-item border-0 p-0 mb-3">
                                <p class="text-muted">No accepted requests available.</p>
                            </div>
                        @endforelse
                    </div>
                </div>
                ...
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            <a href="{{ route('profile.edit') }}" class="list-group-item list-group-item-action border-0 py-3">
                            ...
                            <a href="{{route('consultant.transaction.history')  }}" class="list-group-item list-group-item-action border-0 py-3">
                                <div class="d-flex align-items-center">
            ...
            <div class="col-md-6 col-xl-3">
                <div class="card border-0 shadow-sm h-100">
                    <div class="card-body">
                        ...
                        <div class="list-group">
                            <a href="{{route('consultant.services')  }}" class="list-group-item list-group-item-action border-0 py-3">
                                <div class="d-flex align-items-center">
                                    <div class="bg-primary bg-opacity-10 rounded p-2 me-3">
                                        <i class="bi bi-list text-primary"></i>
                                    </div>
                                    <span>Create Your Service</span>
                                </div>
                            </a>
                            <a href="{{route('consultant.assessment.all-request',  ['status' => 'accepted'])  }}" class="list-group-item list-group-item-action border-0 py-3">
                                <div class="d-flex align-items-center">
                                    <div class="bg-success bg-opacity-10 rounded p-2 me-3">
