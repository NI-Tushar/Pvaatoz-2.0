...
<div class="row">
    <div class="col-md-6 com-sm-12">
        <form method="POST" action="{{ route('consultant.trainings.update') }}" method="POST">
        @csrf
        <input type="hidden" name="id"  value="{{ $training_data['id'] }}">
            <div class="m-2 card">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="training_title" type="text" class="form-control" value="{{ $training_data['training_title'] }}" placeholder="Title of training" required>
                        </div>
                        @error('name')
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="organization" value="{{ $training_data['organization'] }}" placeholder="Organization name" required>
                        </div>
                        @error('email')
                        <div id="emailHelp" class="form-text">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="duration" value="{{ $training_data['duration'] }}" placeholder="Training Duration" required>
                        </div>
                        @error('email')
                        <div id="emailHelp" class="form-text">{{ $message }}</div>
                        @enderror
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="date" name="year" class="form-control" placeholder="Your Training Year" value="{{ $training_data['year'] }}" required>
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="mb-3">
                        <div class="form-group">
                            ...
                            <input type="text" name="result" class="form-control" placeholder="Result or Grade of your training" value="{{ $training_data['result'] }}" required>
                        </div>
                        @error('phone')
                        <div id="emailHelp" class="form-text">{{ $message }}</div>
                        @enderror
