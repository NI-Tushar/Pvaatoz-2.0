...
<style>
    ...
    <div class="qualifications">
        <div class="heading">
            ...
            <!-- <div class="part add">
                <a href="{{ route('consultant.trainings.add') }}"><button>Add</button></a>
            </div> -->
        </div>
        <div class="table_div">
            <table class="table">
                ...
                <tbody>
                    ...
                    @foreach ($training_data as $data)
                        <tr>
                            ...
                            <td>{{ $data->training->training_type }}</td>
                            <td>{{ $data->training->organization }}</td>
                            <td>{{ $data->training->duration }}</td>
                            <td>{{ $data->training->price }}</td>
                            <td>
                                <!-- <div class="action_div">
                                <a href="{{ route('consultant.trainings.edit', $data->id) }}" class="text-blue-500">
                                    <i class="fa-solid fa-pen-to-square"></i>
                                </a>    
                                <a href="{{ route('consultant.trainings.detete', $data->id) }}" class="delete">
            ...
            @if($training_data->isEmpty())
                <p style="color:crimson;font-weight:600; width:100%;text-align:center;">No Training data available.</p>
            @endif
        </div>
    </div>
@endsection
