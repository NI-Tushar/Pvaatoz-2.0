...
class User extends Authenticatable
{
    ...
    {
        return $this->hasOne(Student_infos::class, 'user_id');
    }
    ...
    public function trainingOrCourse()
    {
    ...
    {
        return $this->hasMany(ConsultantsQualifications::class, 'user_id');
    }
    ...
    public function agency() {
        return $this->hasOne(AgencyConsultant::class, 'user_id', 'id');
    }


    // For Consultants (who receive reviews)
